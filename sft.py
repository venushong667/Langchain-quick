...
from transformers import AutoModelForCausalLM, BitsAndBytesConfig, HfArgumentParser, TrainingArguments, Seq2SeqTrainingArguments, set_seed
...
@dataclass
class ScriptArguments(Seq2SeqTrainingArguments):
    """
    ...
    resume_from_checkpoint: Optional[str] = field(
        default=None, metadata={"help": "resume from checkpoint path"}
    )
